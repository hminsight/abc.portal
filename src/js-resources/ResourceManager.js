window.ResourceManager = {
  ...
  ADX_Shortcut_Target_Instructions:
    "Select a shortcut target. A target URL to an external site must begin with http:// or https://.",
  ADX_Shortcut_ShortName: "shortcut",
  SitemapChildren_HiddenFrom_Sitemap_Tooltip:
    "This item is hidden from the site map and won\u0027t appear in navigation elements. It can still be linked to directly.",
  ADX_Weblink_DisplayPage_Childlinks_Tooltip:
    "This web Link is set to display page child links. A child of any child web links shown here won\u0027t be displayed.",
  ADX_Community_Forum_Thread_ShortName: "thread",
  Entity_Form_Select_New: "+ New",
  Required_Secure_ViewConfiguration_Not_Provided:
    "A required secure ViewConfiguration was not provided.",
  Click_Stay_To_Save_Your_Changes:
    "Your changes haven\u0027t been saved. Would you like to stay on the page to save your changes?",
  ...
  Service_URL_To_Associate_Request_Could_Determined:
    "The URL to the service for this Associate Request could determined.",
  Service_URL_Not_Provided: "A required service URL wasn\u0027t provided.",
  Required_Regarding_EntityReference_Parameter_Was_Not_Provided:
    "A required regarding AssociatedTableReference parameter was not provided.",
  URL_Service_For_Add_Note_Request_Could_Not_Determined:
    "The URL to the service for this Add Note Request couldn\u0027t be determined.",
  URL_Service_For_Update_Note_Request_Could_Not_Determined:
    "The URL to the service for this Update Note Request couldn\u0027t be determined.",
  ...
  Published_UnPublished_Entities_Title:
    "Click to toggle preview mode. When on, published and unpublished entities are shown. When off, only published entities can be seen.",
  ...
  Select2_One_Result_Available:
    "One result is available. To select it, press Enter.",
  Select2_Many_Results_Available:
    " results are available, use the Up and Down arrow keys to navigate.",
  ...
  ElFinder_File_Folder_Name_Exist:
  ...
  ElFinder_Maximum_FileSize_Exceeded:
  ...
  CalendarControl_LoadingError:
    "There was a problem loading data for this calendar.",
  Close_DefaultText: "Close",
  ADX_CommunityForumPost_DeleteEntireThread_Warning:
    "Warning: Deleting the first post will delete the entire thread.",
  ...
  MaxLength_Validation_Error:
    "{0} exceeds the maximum length of {1} characters.",
  ...
  Invalid_Floating_Point_Value_Error:
    "{0} must be a valid floating-point value.",
  ...
  SiteMarker_WarningMessage:
    "This {0} is associated with the sitemarker {1}. Site functionality may depend on this association. ",
  SiteMarkers_WarningMessage:
    "This {0} is associated with the sitemarkers {1}. Site functionality may depend on this association. ",
  ...
  Validation_ChildPage_PartialUrl_NotSlash_Message:
    "Please enter a valid partial URL with alphabets, numbers, and hyphens or underscores",
  Validation_ChildPage_PartialUrl_NotUnique_Message:
    "Web page with same partial url already exists.",
  Validation_HomePage_PartialUrl_NotSlash_Message:
    "Value of Partial URL field of the Home Page of your website can only be /. Any other value will lead to issues in your Portal.",
  ...
  All: "All",
  Sharepoint_File_Size_Not_Supported:
    "One or more files are larger than the maximum allowed file size of {0} MB.",
  Sharepoint_Total_File_Size_Not_Supported:
    "The total file size exceeds the maximum allowed limit of {0} MB per upload.",
  ...
  New_Editor_Preview_Label:
    "A new and simplified content editor is available for portal customization.",
  ...
  Length_ErrorText:
    "You’ve reached the maximum characters allowed in this field.",
  ...
  Entitylist_Error_Text_For_Offline_Experience:
    "You\u0027re not connected to the internet. Connect to see this list.",
  ...
  MaxSize_Image_Exceeded:
    "Image is too large to upload. The maximum supported image size is {0} MB.",
  Max_Attachment_Limit_Exceeded:
    "The total size of all attachments exceeds the supported file limit of 128 MB",
  MaxSize_File_Error:
    "File is too large to upload. The maximum supported file size is {0} MB.",
  ...
  Pressed: "Pressed",
  Pva_Privacy_Message:
    "Bot responses are AI-generated so inaccuracies are possible.",
  Completed: "Completed",
};
